...
import { Button, NativeModules, PermissionsAndroid, Platform, SafeAreaView, TextInput, View } from 'react-native';
import {
  BLEPrinter
...
BluetoothPrinterModule.printText('Hola mundo desde Kotlin').then((res: string) => {
    console.log(res);
}).catch((err: any) => {
    console.error(err);
});
