...
export default function home() {
    ...
    useFocusEffect(
        useCallback(() => {
            if (Platform.OS == "android") {
                console.log("first")
                BluetoothPrinterModule.checkBluetoothStatus().then(() => {
                    ...
                    ToastAndroid.show("BLUETOOTH DESACTIVADO: se necesita que este habilitado", ToastAndroid.CENTER)
    ...
    const onStart = async () => {
        try {
            BluetoothPrinterModule.startBackgroundService(selectPrint.model, selectPrint.name, selectPrint.ticket, selectPrint.address_ip)
                .then((res: string) => {
                    console.log(res);
            ...
            ToastAndroid.show("Ocurrio un problema al momento de iniciar el servicio", ToastAndroid.CENTER)
        }
    };
        ...
        <ScrollView style={styles.container}>
            <View style={styles.content}>
                ...
                <View style={styles.servicesPanel}>
                    ...
                    <TouchableOpacity style={styles.serviceRow} onPress={onActiveBluetooth}>
                ...
                <View style={styles.devicesPanel}>
                    ...
                    {listPos.map((device, index) => (
                        <View key={index}>
                            ...
                            <TouchableOpacity style={styles.deviceRow} onPress={() => {
                                setSelectPrint({
                                    model: "N/A",
                ...
                <View style={styles.controlPanel}>
                    <TouchableOpacity
                        ...
                        onPress={() => {
                            if (!activeBluetooth) ToastAndroid.show("POR FAVOR ACTIVA EL BLUETOOTH PARA CONTINUAR...", ToastAndroid.CENTER)
